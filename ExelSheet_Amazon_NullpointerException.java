...
public class ExelSheet_Amazon_NullpointerException
{
	@Test
	public void Login() throws EncryptedDocumentException, IOException
	{
	    ...
	    String UN= w1.getSheet("Login_details").getRow(7).getCell(8).getStringCellValue();
	   // fetching the empty cell by passing row and cell coordinates
