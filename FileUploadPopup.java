...
public void GTMRegistration()
{
  ...
  WebElement PresentAddress= driver.findElement(By.name("Present-Address"));
	   ...
	   Select S3=new Select(E3);
	     ...
	     WebElement fileupload=driver.findElement(By.id("file")); //fileupload popup
	     fileupload.sendKeys("H:\\Users\\shaki\\Downloads\\shakiraPDF.pdf");
